function [train_h0_data, train_h0_label, train_h1_data, train_h1_label]=svm_hcad(index, data_name)
...
[train_h0_data, train_h0_label] = train_h0(index, X, Y, selection_method, Y_temp,Ytemp);

[train_h0_data, train_h0_label] = energy_normalization(train_h0_data, train_h0_label);

[train_h1_data, train_h1_label] = train_h1(index, X, Y, selection_method, Y_temp,Ytemp);

[train_h1_data, train_h1_label] = energy_normalization(train_h1_data, train_h1_label);

end

function [train_h0_data, train_h0_label] = train_h0(index, X, Y, selection_method, Y_temp,Ytemp)
Y_AD=[];
X_train = double(X);
...
% feature Selection on training data
    ...
    index2=[index1;index];
    index3=find(index2==index)
    train_h0_data=train_h0_data1(index2,:);
    ...
    train_h0_data = train_h0_data1(index2,a);
    train_h0_data(index3,:)=[];
    train_h0_label(index3)=[];
...
function [train_h1_data, train_h1_label] = train_h1(index, X, Y, selection_method, Y_temp,Ytemp)
...
% feature Selection on training data
    ...
    b=ranking(1:k);
    a=rank(1:n);
    Y_ADtemp(index3) =  ~Y_ADtemp(index3);
    train_h1_label= Y_ADtemp;
    train_h1_data = train_h0_data1(index2,a);
    train_h1_data(index3,:)=[];
    train_h1_label(index3)=[];
